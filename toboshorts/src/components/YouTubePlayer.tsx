...
export default function YouTubePlayer({ video, isActive }: YouTubePlayerProps) {
  ...
  const videoSrc = `https://www.youtube.com/embed/${videoId}?autoplay=1&mute=0&controls=1&modestbranding=1&rel=0&iv_load_policy=3&enablejsapi=1&loop=1&fs=1&playlist=${videoId}`;
